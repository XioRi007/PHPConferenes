            ...
            <form method="POST" class="bordered form">
                ...
                <div class="row">
                    <div class="mb-3 col">
                        ...
                        <input type="date" class="form-control" id="date" name="date" required value="<?php echo (new DateTime())->format('Y-m-d'); ?>">
                    </div>
                    <div class="mb-3 col">
                        <label for="time" class="form-label">Time</label>
                        <input type="time" class="form-control" id="time" name="time" required value="<?php echo (new DateTime())->format('H:i'); ?>">
                    </div>                    
                </div>
